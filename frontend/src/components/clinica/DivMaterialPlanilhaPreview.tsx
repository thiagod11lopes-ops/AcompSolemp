...
/** Viewport: no máximo 15 linhas de dados + cabeçalho (rolagem vertical/horizontal na base). */
const DIV_MAT_VISIBLE_BODY_ROWS = 15
        ...
        {!visible ? (
          ...
          <Box
            ...
            sx={{
              ...
              width: '100%',
              maxWidth: '100%',
              // Máx. 15 linhas visíveis; barras de rolagem na base/lateral do viewport.
