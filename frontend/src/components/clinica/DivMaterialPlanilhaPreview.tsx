...
/** Viewport: no máximo 10 linhas de dados + cabeçalho (rolagem vertical/horizontal na base). */
const DIV_MAT_VISIBLE_BODY_ROWS = 10
        ...
        {!visible ? (
          ...
          <Box
            ...
            sx={{
              ...
              width: '100%',
              maxWidth: '100%',
              // Máx. 10 linhas visíveis; barras de rolagem na base/lateral do viewport.
