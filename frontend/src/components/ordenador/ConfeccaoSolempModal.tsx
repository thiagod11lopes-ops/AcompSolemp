    ...
    >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="h5" sx={{ fontWeight: 800, lineHeight: 1.2 }}>
              Enviar para Solemp em Rascunho
            </Typography>
            {pedidoNumero && (
              <Chip
                label={pedidoNumero}
      ...
      <DialogContent sx={{ px: 3, pb: 3, pt: 0 }}>
        ...
        >
          ...
          <Chip label="Solemp em Rascunho" size="small" color="primary" />
        </Box>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
          Informe o número e o valor da SOLEMP para concluir a confecção e enviar a Solemp em Rascunho.
        </Typography>
        ...
        >
          ...
          >
            {loading ? 'Enviando...' : 'Enviar para Solemp em Rascunho'}
          </Button>
        </Box>
      </DialogContent>
    </Dialog>
